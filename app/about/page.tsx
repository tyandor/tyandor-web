...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h1 className="text-7xl font-bold font-mono mb-8 text-text-emphasis">About</h1>
      <div ref={contentRef} className="prose opacity-0">
        <p>
        ...
        <h2 className="font-mono">Design notes</h2>
        <p>
