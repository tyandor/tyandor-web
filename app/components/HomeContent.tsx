    ...
    <>
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 gap-4 my-10 articles-section">
          <h2 className="text-2xl mb-2 font-bold font-mono text-text-emphasis">articles</h2>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mt-4 mb-12">
          <h2 className="text-2xl mb-4 font-bold font-mono text-text-emphasis">tools</h2>
        ...
        <div className="my-10">
          <h2 className="text-2xl mb-4 font-bold font-mono text-text-emphasis">design</h2>
