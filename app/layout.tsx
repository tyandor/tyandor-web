    ...
    <html lang="en" className="h-full" suppressHydrationWarning>
      <body className={`${inter.className} flex flex-col min-h-screen bg-rosePine-overlay text-rosePine-text`}>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <Navigation />
          <main id="main-content" className="flex-grow container mx-auto mt-2 mb-10 px-4 md:px-8 py-12 shadow-2xl rounded-2xl bg-rosePine-base" style={{borderRadius:"5rem"}}>
            {children}
          </main>
          <Footer />
        </ThemeProvider>
